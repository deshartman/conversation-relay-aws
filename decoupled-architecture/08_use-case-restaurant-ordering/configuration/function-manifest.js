...
let tools = [
  {
    ...
    function: {
      ...
      description:
        "When an order is complete use this tool to save this order.",
      parameters: {
        type: "object",
        properties: {
          current_order: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "After an order has been confirmed, check to see when the order will be ready for pickup.",
      parameters: {
        type: "object",
        properties: {
          order_type: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "After an order has been confirmed, check to see when the order will be delivered.",
      parameters: {
        type: "object",
        properties: {
          order_type: {
